...
@section('content')
    ...
    <div style="text-align:center;padding:2rem 0 1.5rem">
        ...
        <p style="font-size:0.85rem;color:var(--theme-muted)">{{ __('ui.auth.login.subtitle') }}</p>
    </div>
    ...
    <p style="text-align:center;font-size:0.82rem;color:var(--theme-muted);margin-top:1.25rem">
        ...
        <a href="{{ route('register') }}" style="color:#6a329f;font-weight:600;text-decoration:none">{{ __('ui.auth.login.create_free') }}</a>
    </p>
