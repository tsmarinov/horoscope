...
(function() {
    ...
    function draw() {
        ...
        // ── Planet–planet natal aspects + glyphs ──────────────────────────────
        ...
        // ── Natal planet glyphs at RPG=112 (with spread + clampToSign) ────────
        var BODY_G = ['\u2609','\u263d','\u263f','\u2640','\u2642','\u2643','\u2644','\u26e2','\u2646','\u2647','\u26b7','\u260a','\u26b8'];
        ...
        for (var i = 0; i < PL.length; i++) {
            pts.push({body:PL[i].body, lon:PL[i].lon, rx:PL[i].rx, origA:l2a(PL[i].lon), a:l2a(PL[i].lon), r:RPG});
        }
