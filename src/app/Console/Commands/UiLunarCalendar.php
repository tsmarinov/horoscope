    ...
    public function handle(): int
    {
        ...
        foreach ($days as $d => $day) {
            ...
            if ($day['sign_idx'] !== $prevSignIdx) {
                $dayBlock = TextBlock::pickForProfile('moon_in_' . strtolower($signName), $daySection, 'en', $gender, $profile?->id);
                if ($dayBlock) {
        ...
        if (empty($lunations)) {
            ...
            foreach ($lunations as $lun) {
                ...
                $tagBlock = TextBlock::pickForProfile($tagKey, $tagSection, 'en', $gender, $profile?->id);
